...
// Weights D2Q9
__device__ const double w[Q9] = {4.0 / 9.0,  1.0 / 9.0,  1.0 / 9.0,  1.0 / 9.0, 1.0 / 9.0,
...
__device__ __host__ int findOpposite(int i); // Find opposite direction based on i		// i:    0, 1, 2, 3, 4, 5, 6, 7,
                                             // 8 opp:  0, 2, 1, 4, 3, 7, 8, 5, 6
